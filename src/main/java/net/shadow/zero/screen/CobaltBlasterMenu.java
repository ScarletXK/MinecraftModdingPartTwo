package net.shadow.zero.screen;
...
import net.shadow.zero.block.entity.CobaltBlasterBlockEntity;
import net.shadow.zero.screen.slot.ModFuelSlot;
import net.shadow.zero.screen.slot.ModResultSlot;
