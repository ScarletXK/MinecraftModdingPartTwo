...
public class TigerRenderer extends GeoEntityRenderer<TigerEntity> {
    ...
    @Override
    public RenderType getRenderType(TigerEntity animatable, float partialTicks, PoseStack stack, MultiBufferSource renderTypeBuffer, VertexConsumer vertexBuilder, int packedLightIn, ResourceLocation textureLocation){
